...
namespace Firefox_Nightly_x86_Launcher
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            if (File.Exists(applicationPath + "\\Firefox Nightly x86\\Firefox.exe"))
            {
                ...
                if (!File.Exists(applicationPath + "\\Firefox Nightly x86\\updates\\Profile.txt"))
                {
                    ...
                    {
                        Process.Start(applicationPath + "\\Firefox Nightly x86\\Firefox.exe", Arguments);
                    }
                }
                else
                {
            ...
            {
                _ = MessageBox.Show("Firefox Nightly x86 ist nicht installiert", "Firefox Nightly x86 Launcher", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            else if (culture1.TwoLetterISOLanguageName == "ru")
            {
                _ = MessageBox.Show("Mozilla Firefox не найден", "Firefox Nightly x86 Launcher", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            else
            {
                _ = MessageBox.Show("Firefox Nightly x86 is not installed", "Firefox Nightly x86 Launcher", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
    }
}
