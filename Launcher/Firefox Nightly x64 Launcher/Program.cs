...
namespace Firefox_Nightly_x64_Launcher
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            if (File.Exists(applicationPath + "\\Firefox Nightly x64\\Firefox.exe"))
            {
                ...
                if (!File.Exists(applicationPath + "\\Firefox Nightly x64\\updates\\Profile.txt"))
                {
            ...
            {
                _ = MessageBox.Show("Firefox Nightly x64 ist nicht installiert", "Firefox Nightly x64 Launcher", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            else if (culture1.TwoLetterISOLanguageName == "ru")
            {
                _ = MessageBox.Show("Mozilla Firefox не найден", "Firefox Nightly x64 Launcher", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            else
            {
                _ = MessageBox.Show("Firefox Nightly x64 is not installed", "Firefox Nightly x64 Launcher", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
    }
}
